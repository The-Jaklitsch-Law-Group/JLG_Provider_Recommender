...
from provider_utils import load_provider_data, calculate_distances, recommend_provider
...
class TestEndToEndWorkflow:
    ...
    def test_complete_recommendation_workflow(self):
        ...
        # Calculate distances
        self.test_provider_data["Distance (Miles)"] = calculate_distances(
            user_lat, user_lon, self.test_provider_data
        )
    ...
    def test_edge_case_single_provider(self):
        ...
        single_provider["Distance (Miles)"] = calculate_distances(
            user_lat, user_lon, single_provider
        )
    ...
    def test_edge_case_no_qualifying_providers(self):
        ...
        best, scored_df = recommend_provider(
            self.test_provider_data,
            min_referrals=50  # Higher than max of 12
        )
...
class TestDataValidationIntegration:
    ...
    def test_mixed_quality_data(self):
        ...
        mixed_data["Distance (Miles)"] = calculate_distances(
            user_lat, user_lon, mixed_data
        )
...
class TestPerformanceIntegration:
    ...
    def test_large_dataset_performance(self):
        ...
        large_dataset["Distance (Miles)"] = calculate_distances(
            user_lat, user_lon, large_dataset
        )
