...
def sample_provider_data():
    ...
    return pd.DataFrame({
        ...
        'Full Address': ['123 Main St, City, ST 12345', '456 Oak Ave, City, ST 12346', 
                        '789 Pine Rd, City, ST 12347', '321 Elm St, City, ST 12348'],
...
class TestProviderDataValidation:
    ...
    def test_validate_provider_data_missing_columns(self):
        ...
        invalid_df = pd.DataFrame({
            'Name': ['Provider 1'],  # Wrong column name
            'Address': ['123 Main St']
        })
