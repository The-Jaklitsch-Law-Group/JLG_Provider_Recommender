        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            try:
                ...
                _log_performance_metrics(
                    func_name, execution_time, start_memory, 
                    slow_threshold, log_memory, success=True
                )
                ...
                _log_performance_metrics(
                    func_name, execution_time, start_memory, 
                    slow_threshold, log_memory, success=False, error=str(e)
                )
                raise
...
def _log_performance_metrics(func_name: str, execution_time: float, start_memory: Optional[float],
                           slow_threshold: float, log_memory: bool, success: bool, error: Optional[str] = None):
        ...
        def decorator(func: Callable) -> Callable:
            ...
            def wrapper(*args, **kwargs) -> Any:
                ...
                if isinstance(result, pd.DataFrame):
                    ...
                    perf_logger.info(
                        f"Operation [{operation_name}]: {execution_time:.3f}s, {memory_used:.1f}MB"
                    )
